...
# A low rarity score means the image lies in a denser, more typical region of the
# real data manifold.  Per the paper: "for rarity, we keep those with the lowest
# scores" (ascending sort, reverse=false).
